...
///     demand {
///         admob(nativeAdUnitId: "<adUnitId>", options: AdMobNativeAdOptions())
///     }
/// }
/// ```
/// - Parameters:
...
/// - Returns: A demand component representing AdMob bidding.
public func admob(nativeAdUnitId: String, options: AdMobNativeAdOptions) -> DemandComponent {
...
private struct AdMob: DemandComponent {
    ...
    func apply(to adRequest: AdRequest) -> AdRequest {
        ...
        modified.append(interceptor: NimbusAdMobRequestInterceptor(
            adUnitId: adUnitId,
